...
## Aug 20 — 3pm Snapshot (Day 31, Thursday)
**Portfolio:** $95,844.82 | **Cash:** $19,350.42 (20.19%) | **Day P&L:** -$377.30 (-0.39%) | **Phase P&L:** -$4,155.18 (-4.16%)
**Core exposure:** $9,394.84 (9.80% of equity) | **Satellite exposure:** $10,349.96 (10.80% of equity) | **Income exposure:** $56,749.60 (59.21% of equity)

| Ticker | Sleeve | Shares | Entry | Close | Day Chg | Unrealized P&L | Stop |
|---|---|---|---|---|---|---|---|
| BAX | core | 356 | $27.27 | $26.39 | -0.94% | -$313.28 (-3.23%) | 10% trailing ($24.705) |
| MNKD | satellite | 1215 | $4.00 | $4.285 | -2.50% | +$346.28 (+7.13%) | 15% trailing ($3.74) |
| RIGL | satellite | 114 | $41.84 | $45.12 | -3.92% | +$373.92 (+7.84%) | 15% trailing ($40.239) |
| EDGX | income | 746 | $26.78 | $26.88 | -0.46% | +$74.60 (+0.37%) | 5% trailing ($25.9825) |
| SGOV | income | 166.740 | $100.578175 | $100.5978 | +0.01% | +$3.27 (+0.00%) | 5% trailing ($95.57, 166 sh covered) |
| SPHY | income | 856 | $23.36 | $23.275 | -0.15% | -$72.76 (-0.36%) | 5% trailing ($22.2015) |

**Notes:** No trade activity today in any sleeve — no "### Approved Trades
(verified)" section existed anywhere in today's RESEARCH-LOG (pre-market,
9:30am, 11am, and this 3pm check all confirm none, still blocked by the stale
"Week of 2026-08-07" watchlist), so the buy side stayed HOLD across all four
windows; this week (Aug 17 start) closes at core 0/6, satellite 0/4 new
trades. Risk sweep: no position at/beyond its sleeve hard-cut (BAX -3.23% vs.
the -7% core cut; MNKD +7.13% and RIGL +7.84%, both in gain, vs. the -15%
satellite cut); all 6 open positions confirmed via `alpaca.sh
orders`/`positions` carrying live GTC trailing stops, none missing (SGOV's
0.740468683-sh fractional remainder stays unstopped, same immaterial ~$74 dust
flagged every prior sweep, not a new gap). RIGL's trailing stop ratcheted up
on its own from $40.1625 to $40.239 (hwm $47.34) — mechanical trail, not a
manual move. Fresh WebSearch thesis check on BAX/MNKD/RIGL found no negative
news on any name: BAX's $500M senior-notes tender settled early today as
scheduled and the interim-CFO seat was permanently filled (John Rogers named
CFO), which resolves rather than adds uncertainty; MNKD reconfirmed the 7/23
Furoscix ReadyFlow approval, an end-of-August launch, and a $50M private
placement funding the $45M scPharmaceuticals milestone; RIGL reconfirmed the
Q2 beat, raised FY26 guidance ($285-295M) and the 8/13 VEPPANU launch. No
thesis break, nothing cut. No satellite catalyst inside the 1-2 trading-day
gap-risk window (MNKD's FUROSCIX PDUFA resolved 7/24; RIGL's VEPPANU launch
resolved 8/13; RIGL's R289 LR-MDS readout guided by the company to year-end,
not near-term). No stop tightening this window — MNKD and RIGL both remain far
below the +25% satellite tighten threshold and BAX is in loss, so no core
tighten applies. No stop moved down. 2-strike sub-sector tracker unchanged:
biotech 1/2 (OCUL 7/23), industrials 0/2. Cash 20.19%, at/above the 20% floor,
no sweep needed. Risky positions closed today: none. Day P&L (-0.39%) is
almost entirely the satellite sleeve continuing this morning's sector-beta
give-back (MNKD -2.50%, RIGL -3.92% on the day, no single-name news on
either), with BAX and the income sleeve modestly softer. Phase P&L now -4.16%
since Day 0 ($100,000 -> $95,844.82). Core sleeve still holds only BAX (1 of 6
slots, 9.80% exposure) — the low core deployment is a direct consequence of
the stale watchlist, not a deliberate pass, and a fresh screen is the fix, not
a forced trade. Tomorrow (Fri 8/21): the weekly review + screen refresh is the
whole agenda — WATCHLIST.md is now 14 days stale (3 consecutive
missed/duplicated Friday refreshes: 7/17, 7/31, 8/14) and is the binding
...
## Aug 24 — 3pm Snapshot (Day 33, Monday)
**Portfolio:** $95,636.54 | **Cash:** $19,350.42 (20.24%) | **Day P&L:** -$195.76 (-0.20%) | **Phase P&L:** -$4,363.46 (-4.36%)
**Core exposure:** $9,382.38 (9.81% of equity) | **Satellite exposure:** $10,161.26 (10.62% of equity) | **Income exposure:** $56,742.49 (59.32% of equity)

| Ticker | Sleeve | Shares | Entry | Close | Day Chg | Unrealized P&L | Stop |
|---|---|---|---|---|---|---|---|
| BAX | core | 356 | $27.27 | $26.355 | +0.06% | -$325.74 (-3.36%) | 10% trailing ($24.705) |
| MNKD | satellite | 1215 | $4.00 | $4.125 | -0.60% | +$151.88 (+3.13%) | 15% trailing ($3.74) |
| RIGL | satellite | 114 | $41.84 | $45.17 | -1.57% | +$379.62 (+7.96%) | 15% trailing ($40.239) |
| EDGX | income | 746 | $26.78 | $26.81 | -0.31% | +$22.38 (+0.11%) | 5% trailing ($25.9825) |
| SGOV | income | 166.740 | $100.578175 | $100.6378 | +0.01% | +$9.94 (+0.06%) | 5% trailing ($95.608, 166 sh covered) |
| SPHY | income | 856 | $23.36 | $23.3199 | +0.09% | -$34.33 (-0.17%) | 5% trailing ($22.2015) |

**Notes:** No trade activity today in either sleeve — no "### Approved
Trades (verified)" section existed anywhere in today's RESEARCH-LOG
(pre-market, 9:30am, 11am, and this 3pm check all confirm none, still
blocked by the stale "Week of 2026-08-21" watchlist for a fresh core name
and no satellite candidate clearing), so the buy side stayed HOLD across
all four windows; this week (Aug 24 start) closes at core 0/6, satellite
0/4 new trades — valid per the Patience Rule. Risk sweep: no position
at/beyond its sleeve hard-cut (BAX -3.36% vs. the -7% core cut; MNKD
+3.13%, RIGL +7.96%, both in gain vs. the -15% satellite cut); all 6 open
positions confirmed via `alpaca.sh positions`/`orders` carrying live GTC
trailing stops, none missing (SGOV's 0.740468683-sh fractional remainder
stays unstopped, same immaterial ~$75 dust flagged every prior sweep, not
a new gap). Fresh WebSearch thesis check on BAX/MNKD/RIGL found nothing
new or negative since the 11am note — BAX's CFO transition and $0.01
dividend (ex-date 8/28) remain routine housekeeping with modestly higher
analyst fair-value estimates; MNKD's FUROSCIX ReadyFlow approval and $50M
private placement are unchanged, no new binary; RIGL's VEPPANU commercial
launch (8/13) remains resolved-positive. No thesis break, nothing closed.
No satellite catalyst inside the 1-2 trading-day gap-risk window for
either MNKD or RIGL (both catalysts already resolved) — no gap-risk action
needed. No stop tightening this window — MNKD +3.13% and RIGL +7.96% both
remain well below the +25% satellite tighten threshold; BAX is not in gain
so the core tighten schedule doesn't apply. No stop moved down. 2-strike
sub-sector tracker unchanged: biotech 1/2 (OCUL 7/23), industrials 0/2.
Cash 20.24%, at/above the 20% floor, no sweep needed. Risky positions
closed today: none. Day P&L (-0.20%) driven mainly by BAX/EDGX/MNKD/RIGL
giving back a modest amount of Friday's close, partly offset by flat-to-
slightly-positive SGOV/SPHY. Phase P&L now -4.36% since Day 0 ($100,000 ->
$95,636.54). Core sleeve still holds only BAX (1 of 6 slots, 9.81%
exposure vs. 85% target) — a direct consequence of the current watchlist
having only one qualifying held core name, not a deliberate pass. Tomorrow:
continue monitoring BAX's proximity to its -7% hard-cut and its
second-consecutive-week-off-watchlist status (decided at Friday 8/28's
screen refresh, not mid-week); watch MNKD/RIGL's approach toward their
...
### 2026-08-26 — SELL SGOV (income) — cash-floor sweep (pre-trade, funds XYZ buy)
Shares: 96 | Exit: $100.65 | Realized P&L: ~$0.28 (0.00%) | Reason: pre-trade cash-floor check ahead of the XYZ buy below, per TRADING-STRATEGY.md's SGOV-first buy-funding sweep rule. Pre-trade cash $19,349.27 (20.20% of $95,802.20 equity); a ~$9,580 XYZ buy funded from literal cash alone would have dropped cash to ~$9,770 (10.2%), well below the 20% floor. Order filled 2026-08-26T13:37:17Z, proceeds $9,662.40, cash after $29,011.67.
Mechanics: canceled the standing 166-share 5% trailing stop (e7bbf45f...) ahead of the sale, replaced with a 70-share 5% trailing stop for the reduced position after the XYZ buy filled (see below) — same cancel-then-replace-adjacent pattern as prior sweeps. The 0.740468683-share fractional remainder stays unstopped, same immaterial ~$75 dust flagged every prior sweep.

### 2026-08-26 — BUY XYZ (core)
...
### 2026-08-28 — SELL SGOV (income) — cash-floor sweep (pre-trade, funds APA buy)
Shares: 50 | Exit: ~$100.65 (market) | Realized P&L: ~$0 (0.00%) | Reason: pre-trade cash-floor check ahead of the APA buy below, per TRADING-STRATEGY.md's SGOV-first buy-funding sweep rule. Pre-trade cash $19,430.79 (20.23% of $96,070.46 equity); a ~$5,160 APA buy funded from literal cash alone would still have cleared the floor on its own, but a full ~10%-of-equity core position (the size pattern used for XYZ on 8/26) would have dropped cash well below 20% — sized the buy to what remaining SGOV could fund (see below) rather than draining SGOV further via the full-size sweep. Order filled 2026-08-28T13:35:33Z.
Mechanics: canceled the standing 70-share 5% trailing stop (58fc3281...) ahead of the sale, replaced with a 20-share 5% trailing stop for the reduced position after the APA buy filled (see below). SGOV is now materially depleted (20.740468683 sh, ~$2,088) relative to its 50%-of-sleeve target split — flagging for the next weekly-review Part C rebalance to true up SGOV/SPHY/EDGX proportions; per TRADING-STRATEGY.md, SPHY/EDGX are never tapped for buy-funding, so today's core position was sized down to fit available SGOV rather than breaching that rule.

### 2026-08-28 — BUY APA (core)
...
Funding reason (income only): pre-trade cash $28,124.05 (30.55% of $92,067.02 equity, per `alpaca.sh account` at market-open) vs. the 20% floor (~$18,413) — swept 94 sh (~$9,444) into SGOV, leaving cash at $18,684.57 (20.26% of $92,212.22 post-trade equity), a small buffer above the floor consistent with the sizing pattern used in prior sweeps.
Mechanics: canceled the standing 20-share 5% trailing stop before the buy, replaced with a 114-share 5% trailing GTC stop after fill (0.740468683-sh fractional remainder stays unstopped, same immaterial ~$74 dust flagged every prior sweep, not a new gap).
...
## Sep 4 — 3pm Snapshot (Day 44, Friday)
**Portfolio:** $94,224.92 | **Cash:** $19,051.41 (20.22%) | **Day P&L:** -$43.62 (-0.05%) | **Phase P&L:** -$5,775.08 (-5.78%)
**Core exposure:** $5,204.21 (5.52% of equity) | **Satellite exposure:** $10,512.05 (11.16% of equity) | **Income exposure:** $59,457.26 (63.11% of equity)

| Ticker | Sleeve | Shares | Entry | Close | Day Chg | Unrealized P&L | Stop |
|---|---|---|---|---|---|---|---|
| APA | core | 121 | $42.61 | $43.01 | -2.65% | +$48.40 (+0.94%) | 10% trailing ($40.6125) |
| MNKD | satellite | 1215 | $4.00 | $4.075 | +2.90% | +$91.13 (+1.88%) | 15% trailing ($3.74) |
| RIGL | satellite | 114 | $41.84 | $48.78 | +0.58% | +$791.16 (+16.59%) | 15% trailing ($42.415) |
| EDGX | income | 746 | $26.78 | $27.0299 | -0.09% | +$186.43 (+0.93%) | 5% trailing ($25.9825) |
| SGOV | income | 193.740468683 | $100.454053 | $100.4628 | +0.03% | +$1.69 (+0.01%) | 5% trailing ($95.4465, 193 sh covered) |
| SPHY | income | 856 | $23.36 | $23.165 | -0.02% | -$166.92 (-0.84%) | 5% trailing ($22.23) |

**Notes:** No Core/Satellite trades this window — no "Approved Trades (verified)"
list existed in today's RESEARCH-LOG at any window (pre-market, 9:30am, 11am,
this window), so per STEP 3 the buy side was HOLD all session; this week (Aug
31 start) stays core 1/6 (HPE 8/31, since stopped out), satellite 0/4 new
trades — valid per the Patience Rule. No account activity today at all (no
buys, no sells, no sweeps) — the first fully quiet day this week. Risk sweep
(3pm): no position at/beyond its sleeve hard-cut (APA +0.94% vs. -7% core
cut; MNKD +1.88%, RIGL +16.59%, both vs. -15% satellite cut); all 6 open
positions confirmed via `alpaca.sh positions`/`orders` carrying live GTC
trailing stops, none missing (SGOV's 0.740468683-sh fractional remainder
stays unstopped, same immaterial ~$74 dust flagged every prior sweep, not a
new gap; SGOV's stop hwm ticked up intraday to $100.47/trigger $95.4465, a
normal trailing-stop ratchet, not a manual move). No stop moved down. No
stop tightening this window — APA below the core +15% threshold, MNKD/RIGL
both below the satellite +25% threshold (RIGL at +16.59%, continuing to
approach it — watch). No satellite catalyst inside the 1-2 trading-day
gap-risk window: MNKD's Wells Fargo Healthcare Conference was today (9/4),
confirmed non-binary IR event, no gap-risk sizing triggered; RIGL's Citi
(9/9)/Cantor (9/10) appearances remain outside the window measured from the
next trading day (Tue 9/8, since Mon 9/7 is the Labor Day holiday) and are
non-binary per Gemini's audit. Thesis check: MNKD/RIGL both intact, no
adverse news. **APA's mandatory two-week thesis-broken exit (off the core
watchlist since 8/28, today being the second confirming Friday) did NOT
execute this session** — per the 9:30am and 11am research-log notes,
`routines/README.md`'s weekly-review workflow (the one that actually
re-screens and persists WATCHLIST.md) runs at 4:00pm today, after this 3pm
window closes; acting before that would mean exiting on a refresh that
hasn't happened in the record yet. No adverse APA news found today
(Raymond James PT raise to $54, 9/2). The exit is queued for the next trade
window after today's 4pm weekly-review confirms the list — Tue 9/8
market-open (Mon 9/7 market holiday, no session). 2-strike sub-sector
tracker unchanged: biotech 1/2 (OCUL 7/23), industrials 0/2. Cash 20.22%,
at/above the 20% floor, no sweep needed. Risky positions closed today:
none. Day P&L (-0.05%) essentially flat — APA's intraday pullback (-2.65%)
roughly offset by MNKD's gain (+2.90%) and RIGL/EDGX's modest gains, income
sleeve flat. Phase P&L now -5.78% since Day 0 ($100,000 -> $94,224.92). Core
exposure 5.52% (1 of 6 slots: APA), satellite steady at 11.16% (2 of 4
slots: MNKD, RIGL) — core remains well under its 85% target with 5 of 6
slots open. Tomorrow (next session Tue 9/8, given the Labor Day holiday):
execute APA's mandatory thesis-broken exit if today's 4pm weekly-review
confirms it is still off the core watchlist, regardless of P&L; rebuild
core exposure from fresh candidates once the weekly screen refresh clears
new names through the momentum/FCF/spread gates; continue watching RIGL's
approach toward its +25% satellite tighten threshold.

### 2026-09-08 — SELL APA (core) — mandatory thesis-broken exit
Shares: 121 | Exit: blended $44.281818 (45 sh @ $44.08 + 76 sh @ $44.40) | Realized P&L: +$202.19 (+3.92%) | Reason: thesis-broken exit — off the core watchlist two consecutive Fridays (dropped 8/28, still off 9/4) per TRADING-STRATEGY.md's two-week rule, executed regardless of P&L. No adverse fundamental news; exit is mechanical/rule-driven, not a fundamentals call. Standing 10% GTC trailing stop (trigger $40.6125) canceled before the sell.
Execution anomaly: the market sell order (day TIF) partially filled 45/121 shares ~2 minutes after submission, then stalled indefinitely at that partial fill with no further progress (order remained "partially_filled" with no state change for several more minutes) — first time this pattern has occurred in this account's history; all prior market orders filled instantly and completely. Also noted: `alpaca.sh orders` (status=open list endpoint) returned stale data (showing the order as "new"/filled_qty 0) while a direct per-order GET against the same order ID correctly showed "partially_filled"/filled_qty 45 — a second, distinct data-quality issue (stale list cache) layered on top of the fill anomaly. Resolved by canceling the stalled remainder and resubmitting a fresh market sell for the remaining 76 shares, which filled completely ~60 seconds later. Flagging both anomalies (slow/stalling paper-engine fills, stale open-orders list) for owner awareness — not a strategy or gate failure, a platform/wrapper execution issue.

### 2026-09-08 — BUY SGOV (income) — cash-floor sweep-back after APA exit
Shares: 53 | Entry: $100.48 (market) | Stop: 5% trailing GTC on the combined 246 whole shares (canceled the standing 193-share stop, replaced with one 246-share stop, trigger $95.456, hwm $100.48; 0.740468683-sh fractional remainder stays unstopped, same immaterial ~$74 dust flagged every prior sweep) | Target: n/a | R:R: n/a
Thesis: Income sleeve sweep-back rule (TRADING-STRATEGY.md — sweep freed cash above the 20% floor into SGOV first after a Core/Satellite sell).
...
## Sep 16 — 3pm Snapshot (Day 53, Wednesday)
**Portfolio:** $93,001.44 | **Cash:** $18,777.57 (20.19%) | **Day P&L:** +$27.63 (+0.03%) | **Phase P&L:** -$6,998.56 (-7.00%)
**Core exposure:** $0.00 (0.00% of equity) | **Satellite exposure:** $5,100.36 (5.48% of equity) | **Income exposure:** $69,123.51 (74.33% of equity)

| Ticker | Sleeve | Shares | Entry | Close | Day Chg | Unrealized P&L | Stop |
|---|---|---|---|---|---|---|---|
| RIGL | satellite | 114 | $41.84 | $44.74 | +0.86% | +$330.60 (+6.93%) | 15% trailing ($42.415) |
| EDGX | income | 746 | $26.78 | $26.575 | +0.34% | -$152.93 (-0.77%) | 5% trailing ($25.9825) |
| SGOV | income | 294.989473856 | $100.469501 | $100.54 | +0.01% | +$20.80 (+0.07%) | 5% trailing ($95.5225, 294 sh covered) |
| SPHY | income | 856 | $23.36 | $22.9443 | +0.11% | -$355.84 (-1.78%) | 5% trailing ($22.23) |

**Notes:** No Core/Satellite trades this window (or all session) — no "Approved
Trades (verified)" list existed in today's RESEARCH-LOG at any window (pre-market,
9:30am, 11am, 3pm all HOLD), so per STEP 3 the buy side was HOLD all day; this week
(Sep 14 start) closes the week's midweek session at core 0/6, satellite 0/4 new
trades so far — valid per the Patience Rule. No account activity today at all (no
buys, sells, sweeps, or tightens). Risk sweep (3pm): core has 0 open positions,
nothing to check; satellite RIGL +6.93%, well clear of the -15% hard-cut, no
gap-risk catalyst inside the 1-2 trading-day window (Wainwright conference already
resolved 9/15, non-binary); income EDGX -0.77% and SPHY -1.78%, both well inside
the 5% stop; SGOV +0.07%. All 4 open positions confirmed via
`alpaca.sh positions`/`orders` carrying live GTC trailing stops, none missing
(SGOV's 0.989473856-sh fractional remainder stays unstopped, same immaterial ~$99
dust flagged every prior sweep, not a new gap). No stop moved down. Today's dominant
event: FOMC hiked 25bp to 3.75%-4.00% (first hike since 2023, 12-0 vote), updated
dot plot shows 16 of 18 participants expecting at least one more hike this year —
priced macro outcome, not idiosyncratic to any position; SPHY (high-yield credit)
and SGOV (front-end yield) are the two names structurally exposed but neither shows
a thesis break, both remain well inside their 5% stop. No stop tightening this
window — RIGL (+6.93%) still well below the satellite +25% threshold; Income sleeve
has no gain-based schedule. 2-strike sub-sector tracker unchanged: biotech 2/2
cooldown active through 2026-09-25 (OCUL 7/23, MNKD 9/11); industrials 0/2. Cash
20.19%, at/above the 20% floor, no sweep needed. Risky positions closed today: none.
Day P&L (+0.03%) essentially flat — RIGL's modest gain roughly offset by EDGX/SPHY's
modest softness and SGOV's small gain. Phase P&L now -7.00% since Day 0 ($100,000 ->
$93,001.44). Core exposure remains 0.00% (0 of 6 slots open, 9 consecutive sessions
since APA's 9/8 exit) — rebuilding core exposure from a fresh momentum/FCF/rating-
qualified candidate stays the top priority; today's pre-market research was fully
clean (non-truncated) for the first time in 5 sessions but still sourced no core
candidate to the live buy-side gate. Satellite steady at 5.48% (1 of 4 slots: RIGL
only; biotech sub-sector cooldown active through 9/25, industrials still open).
This week (Sep 14 start): core 0/6, satellite 0/4 new trades so far — valid per the
Patience Rule. Tomorrow (9/17): post-FOMC market reaction is the top item to watch,
particularly SPHY's high-yield credit sensitivity to the hawkish hike/dot-plot
outcome and SGOV's yield capture; EDGX's declared $0.0463/share dividend (ex-date
9/14, already passed) pays 9/17 and reinvests to SGOV per the Income sleeve's fixed
rule; re-verify momentum/FCF/rating live at the buy-side gate for a core rebuild
candidate; continue monitoring RIGL's approach toward its +25% satellite tighten
...
### 2026-08-14 — SELL SGOV (income) — cash-floor sweep (pre-trade, funds PANW buy)
Shares: 74 | Exit: ~$100.63 | Realized P&L: ~-$0.03/sh (~0.00%) | Reason: pre-trade cash-floor check ahead of the PANW buy below — cash was $19,405.76 (20.15% of $96,331.11 equity), leaving only ~$140 of headroom above the 20% floor before any buy. Sold 74 sh (full whole-share balance) to raise cash to $26,846.46 pre-buy, per TRADING-STRATEGY.md's buy-funding sweep rule.
Mechanics: canceled the standing 74-share 5% trailing stop (960a9589...), sold 74 sh market/day, leaving 0.432863884 fractional sh unstopped (same as prior sweeps — sub-1-share remainder too small for a new stop order).

### 2026-08-14 — BUY PANW (core)
Shares: 19 | Entry: $387.45 | Stop: 10% trailing GTC, trigger $348.264 (hwm $386.96) | Target: n/a (no firm analyst PT tied to this entry) | R:R: n/a
Thesis: Core watchlist momentum name, 2026-08-07 screen rank 2 of 22 (3M rel. return +77.9% vs SPY, above both 50d/200d MA), FCF positive/improving (Q3 adj FCF +57% YoY), Buy/Moderate Buy analyst consensus, rev +31.1% on platformization + AI product adoption driving bookings. Pre-market research (8/14) found no material overnight news and no red flags carried forward for PANW specifically. Market-open spread check found PANW clean (0.25%-0.26% bid/ask across two checks) — one of the few names to clear the spread-skip rule this session; the recurring multi-session wide/erratic-spread data-feed anomaly persisted on DELL, CRWD, NTAP, CRL, FFIV, URI, NUE, VLO, MPC, and STT (3.6%-11.2% spreads), all skipped. ANET, ZBRA, PYPL, XYZ, MET, GEN, CNC, GRMN, CSCO also showed clean/acceptable spreads but PANW was the top-ranked clean candidate with no standing caution flag (vs. ANET's valuation/supply-chain caution and XYZ's insider-selling caution, both still just watch items but not preferred over a clean name); PYPL remains excluded on the standing "M&A-price-spike, not momentum+FCF signal" judgment.
Gate: core positions after fill 3/6 (HPE, BAX, PANW), core trades this week 3/6 (HPE 8/12, BAX 8/13, PANW 8/14), cost $7,361.55 = 7.64% of equity ($96,338.18 pre-trade) — under the 20% per-position cap. Cash floor pre-checked and funded via the SGOV sweep above; post-trade cash confirmed $19,484.91 (20.23% of equity $96,332.55) via `alpaca.sh account` — at/above the 20% floor.
